...
class Player(BasePlayer):
    ...
    def play(self, mov):
        ...
        if strength > 5.0:
            ...
            # If accelerating towards north (or decelerating towards south)
            if mov.accel_without_gravity_direction == NORTH:
                self.kick.play(overlap=False)
            # If accelerating towards east (or decelerating towards west)
            elif mov.accel_without_gravity_direction == EAST:
